          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div 
                ...
                className={`relative w-full aspect-video sm:aspect-square lg:aspect-4/3 bg-[#0A0A0A] border border-white/15 overflow-hidden red-glow-card group ${
              ...
              >
                {project.image ? (
                  <>
                    ...
                    <div className="absolute bottom-3 right-3 bg-black/80 backdrop-blur-md border border-white/20 p-2 text-white/80 group-hover:text-red-400 group-hover:border-red-500 transition-all">
